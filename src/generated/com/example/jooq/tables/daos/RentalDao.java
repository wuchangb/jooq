...
import com.example.jooq.tables.pojos.Rental;
...
public class RentalDao extends DAOImpl<RentalRecord, Rental, Long> {
    ...
    @Override
    public Long getId(Rental object) {
     ...
     * upperInclusive</code>
     */
    public List<Rental> fetchRangeOfJRentalId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<Rental> fetchByJRentalId(Long... values) {
     ...
     */
    public Rental fetchOneByJRentalId(Long value) {
     ...
     * Fetch a unique record that has <code>rental_id = value</code>
     */
    public Optional<Rental> fetchOptionalByJRentalId(Long value) {
