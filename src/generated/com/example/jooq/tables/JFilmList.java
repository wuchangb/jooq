...
import com.example.jooq.enums.FilmListRating;
import com.example.jooq.tables.records.FilmListRecord;
...
public class JFilmList extends TableImpl<FilmListRecord> {
     ...
     */
    public final TableField<FilmListRecord, UInteger> FID = createField(DSL.name("FID"), SQLDataType.INTEGERUNSIGNED.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGERUNSIGNED)), this, "");
     ...
     */
    public final TableField<FilmListRecord, BigDecimal> PRICE = createField(DSL.name("price"), SQLDataType.DECIMAL(4, 2).defaultValue(DSL.field(DSL.raw("4.99"), SQLDataType.DECIMAL)), this, "");
     ...
     */
    public final TableField<FilmListRecord, FilmListRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR(5).defaultValue(DSL.field(DSL.raw("'G'"), SQLDataType.VARCHAR)).asEnumDataType(FilmListRating.class), this, "");
