...
import com.example.jooq.enums.FilmRating;
import com.example.jooq.tables.JActor.ActorPath;
import com.example.jooq.tables.JCategory.CategoryPath;
import com.example.jooq.tables.JFilmActor.FilmActorPath;
import com.example.jooq.tables.JFilmCategory.FilmCategoryPath;
import com.example.jooq.tables.JInventory.InventoryPath;
import com.example.jooq.tables.JLanguage.LanguagePath;
...
public class JFilm extends TableImpl<FilmRecord> {
     ...
     */
    public final TableField<FilmRecord, Long> ORIGINAL_LANGUAGE_ID = createField(DSL.name("original_language_id"), SQLDataType.BIGINT.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<FilmRecord, Integer> LENGTH = createField(DSL.name("length"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<FilmRecord, FilmRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR(5).defaultValue(DSL.field(DSL.raw("'G'"), SQLDataType.VARCHAR)).asEnumDataType(FilmRating.class), this, "");
