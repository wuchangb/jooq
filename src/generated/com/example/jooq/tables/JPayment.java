...
import com.example.jooq.tables.JRental.RentalPath;
...
public class JPayment extends TableImpl<PaymentRecord> {
     ...
     */
    public final TableField<PaymentRecord, Long> RENTAL_ID = createField(DSL.name("rental_id"), SQLDataType.BIGINT.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.BIGINT)), this, "");
