...
public class FilmRecord extends UpdatableRecordImpl<FilmRecord> {
     ...
     */
    public FilmRecord(Long filmId, String title, String description, Year releaseYear, Long languageId, Long originalLanguageId, UByte rentalDuration, BigDecimal rentalRate, Integer length, BigDecimal replacementCost, FilmRating rating, String specialFeatures, LocalDateTime lastUpdate) {
        super(JFilm.FILM);
