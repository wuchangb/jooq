...
import com.example.jooq.tables.JCustomer.CustomerPath;
import com.example.jooq.tables.JInventory.InventoryPath;
import com.example.jooq.tables.JPayment.PaymentPath;
import com.example.jooq.tables.JStaff.StaffPath;
...
public class JRental extends TableImpl<RentalRecord> {
     ...
     */
    public final TableField<RentalRecord, LocalDateTime> RETURN_DATE = createField(DSL.name("return_date"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.LOCALDATETIME)), this, "");
