...
import com.example.jooq.tables.records.NicerButSlowerFilmListRecord;
...
public class JNicerButSlowerFilmList extends TableImpl<NicerButSlowerFilmListRecord> {
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, UInteger> FID = createField(DSL.name("FID"), SQLDataType.INTEGERUNSIGNED.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGERUNSIGNED)), this, "");
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, BigDecimal> PRICE = createField(DSL.name("price"), SQLDataType.DECIMAL(4, 2).defaultValue(DSL.field(DSL.raw("4.99"), SQLDataType.DECIMAL)), this, "");
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, NicerButSlowerFilmListRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR(5).defaultValue(DSL.field(DSL.raw("'G'"), SQLDataType.VARCHAR)).asEnumDataType(NicerButSlowerFilmListRating.class), this, "");
