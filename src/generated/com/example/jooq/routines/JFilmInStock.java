...
public class JFilmInStock extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<Long> P_FILM_ID = Internal.createParameter("p_film_id", SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>sakila.film_in_stock.p_store_id</code>.
     */
    public static final Parameter<Long> P_STORE_ID = Internal.createParameter("p_store_id", SQLDataType.BIGINT, false, false);
     ...
     */
    public void setPFilmId(Long value) {
     ...
     */
    public void setPStoreId(Long value) {
